...
function Footer() {   
    ...
    <div class="footer" id="footer">
        <a href="https://github.com/sauln179"><img src="https://img.icons8.com/color/48/000000/github-2.png" alt="Github" class="icon"/></a>
